...
const adminNavigation = [
  ...
  { key: '/admin/contacts-operations', icon: <DatabaseOutlined />, labelKey: 'contactsOperations' },
  { key: '/admin/reports', icon: <LineChartOutlined />, labelKey: 'reports' },
  { key: '/admin/group-monitor', icon: <TeamOutlined />, labelKey: 'groupMonitor' },
  { key: '/admin/billing', icon: <DollarOutlined />, labelKey: 'billing' },
