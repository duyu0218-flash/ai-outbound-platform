...
const zh = {
  ...
  loadMoreContacts: '加载更多客户', selectedContactsCount: '已选择 {{count}} 位客户', previousPage: '上一页', nextPage: '下一页', currentPageNumber: '第 {{page}} 页',
  ...
  aiEnabled: '启用 AI 服务', externalLlmEnabled: '允许外部大模型', agentUrl: 'AI 服务地址', llmProvider: '大模型服务商', llmModel: '模型名称', asrProvider: '语音识别服务', ttsProvider: '语音合成服务', voice: '音色', smsEnabled: '启用短信', senderId: '短信签名', endpoint: '服务地址', hangupTemplate: '挂机短信模板',
  historyTurns: '多轮上下文条数', maxReplyChars: '单轮最大字数', forbiddenPhrases: '禁用表述（逗号分隔）', fallbackReply: '合规拦截后回复',
  dncEnforced: '强制禁呼检查', requireExplicitConsent: '所有外呼必须明确授权', recordingNotice: '播放录音告知', recordingNoticeText: '录音告知内容', maxAttemptsDay: '单号码每日最大尝试', allowedPhonePrefixes: '允许拨打号段', allowedPhonePrefixesHint: '逗号分隔国家码或号段；生产不能为空。', maxCallsPerDay: '租户每日拨号上限', minAttemptInterval: '同一号码最小外呼间隔', minAttemptIntervalHint: '设为 0 表示不限制；对单路和活动外呼同时生效。', recordingRetentionDays: '录音保留天数', partialTranscriptRetentionHours: '临时转写保留小时', finalTranscriptRetentionDays: '最终转写保留天数', callSensitiveDataRetentionDays: '通话敏感数据保留天数', complianceRetentionHint: '频次、目的地和保留策略保存后立即按租户生效；已生成录音保持创建时的到期日期。', startHour: '允许开始小时', endHour: '允许结束小时', callbackEnabled: '启用业务回调', webhookBaseUrl: 'Webhook 地址', webhookTimeout: '回调超时', webhookSecretRef: '签名密钥引用', webhookSecretHint: '从 BUSINESS_WEBHOOK_SECRET_<引用> 环境变量读取，页面不保存密钥。', webhookRetryTimes: '回调重试次数', webhookRetryBackoff: '重试退避', seconds: '秒', lastUpdated: '最后更新',
...
const en: typeof zh = {
  ...
  loadMoreContacts: 'Load more contacts', selectedContactsCount: '{{count}} contacts selected', previousPage: 'Previous page', nextPage: 'Next page', currentPageNumber: 'Page {{page}}',
  ...
  aiEnabled: 'Enable AI service', externalLlmEnabled: 'Allow external LLM', agentUrl: 'AI service URL', llmProvider: 'LLM provider', llmModel: 'Model', asrProvider: 'ASR provider', ttsProvider: 'TTS provider', voice: 'Voice', smsEnabled: 'Enable SMS', senderId: 'Sender ID', endpoint: 'Endpoint', hangupTemplate: 'Hangup SMS template',
  ...
  dncEnforced: 'Enforce DNC checks', requireExplicitConsent: 'Require explicit consent for every call', recordingNotice: 'Play recording notice', recordingNoticeText: 'Recording notice text', maxAttemptsDay: 'Max attempts per number/day', allowedPhonePrefixes: 'Allowed phone prefixes', allowedPhonePrefixesHint: 'Comma-separated country codes or prefixes; required in production.', maxCallsPerDay: 'Tenant daily dial limit', minAttemptInterval: 'Minimum interval for the same number', minAttemptIntervalHint: 'Set to 0 to disable. Applies to direct and campaign calls.', recordingRetentionDays: 'Recording retention days', partialTranscriptRetentionHours: 'Partial transcript retention hours', finalTranscriptRetentionDays: 'Final transcript retention days', callSensitiveDataRetentionDays: 'Call sensitive-data retention days', complianceRetentionHint: 'Frequency, destination and retention settings take effect per tenant after saving. Existing recordings retain their original expiry date.', startHour: 'Allowed start hour', endHour: 'Allowed end hour', callbackEnabled: 'Enable callback', webhookBaseUrl: 'Webhook URL', webhookTimeout: 'Webhook timeout', webhookSecretRef: 'Signing secret reference', webhookSecretHint: 'Reads BUSINESS_WEBHOOK_SECRET_<REFERENCE> from the environment. Secrets are never stored in the UI.', webhookRetryTimes: 'Callback retries', webhookRetryBackoff: 'Retry backoff', seconds: 'sec', lastUpdated: 'Last updated',
