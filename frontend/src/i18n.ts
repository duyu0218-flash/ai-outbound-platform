...
const zh = {
  ...
  dncEnforced: '强制禁呼检查', requireExplicitConsent: '活动必须明确授权', recordingNotice: '播放录音告知', recordingNoticeText: '录音告知内容', maxAttemptsDay: '每日最大尝试次数', minAttemptInterval: '同一号码最小外呼间隔', minAttemptIntervalHint: '设为 0 表示不限制；对单路和活动外呼同时生效。', recordingRetentionDays: '录音保留天数', partialTranscriptRetentionHours: '临时转写保留小时', complianceRetentionHint: '频次和保留策略保存后立即按租户生效；已生成录音保持创建时的到期日期。', startHour: '允许开始小时', endHour: '允许结束小时', callbackEnabled: '启用业务回调', webhookBaseUrl: 'Webhook 地址', webhookTimeout: '回调超时', webhookSecretRef: '签名密钥引用', webhookSecretHint: '从 BUSINESS_WEBHOOK_SECRET_<引用> 环境变量读取，页面不保存密钥。', webhookRetryTimes: '回调重试次数', webhookRetryBackoff: '重试退避', seconds: '秒', lastUpdated: '最后更新',
